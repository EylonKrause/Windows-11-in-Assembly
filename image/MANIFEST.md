...
257 `.asm` files across 9 System32 DLL folders (materialized under `tree/Windows/System32/`).
...
## Windows/System32/kernelbase.dll — 14 functions
`CompareStringOrdinal`, `PathCchAddBackslash`, `PathCchAddExtension`, `PathCchCanonicalizeEx`, `PathCchFindExtension`, `PathCchRemoveBackslash`, `PathCchRemoveExtension`, `PathCchRemoveFileSpec`, `PathCchRenameExtension`, `lstrcpyA`, `lstrcpyW`, `lstrcpynA`, `lstrcpynW`, `lstrlenA`
