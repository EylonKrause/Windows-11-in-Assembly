...
246 `.asm` files across 9 System32 DLL folders (materialized under `tree/Windows/System32/`).
...
## Windows/System32/kernelbase.dll — 11 functions
`CompareStringOrdinal`, `PathCchAddBackslash`, `PathCchAddExtension`, `PathCchFindExtension`, `PathCchRemoveBackslash`, `PathCchRemoveExtension`, `PathCchRenameExtension`, `lstrcpyA`, `lstrcpynA`, `lstrcpynW`, `lstrlenA`
