...
117 `.asm` files across 4 System32 DLL folders (materialized under `tree/Windows/System32/`).
...
## Windows/System32/crypt32.dll — 5 functions
`CryptBinaryToStringA`, `CryptBinaryToStringA`, `CryptBinaryToStringW`, `CryptStringToBinaryA`, `CryptStringToBinaryW`
