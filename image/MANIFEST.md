...
118 `.asm` files across 4 System32 DLL folders (materialized under `tree/Windows/System32/`).
...
## Windows/System32/crypt32.dll — 6 functions
`CryptBinaryToStringA`, `CryptBinaryToStringA`, `CryptBinaryToStringW`, `CryptStringToBinaryA`, `CryptStringToBinaryA`, `CryptStringToBinaryW`
