...
298 `.asm` files across 10 System32 DLL folders (materialized under `tree/Windows/System32/`).
...
## Windows/System32/advapi32.dll — 3 functions
`ConvertSidToStringSidA`, `ConvertSidToStringSidW`, `ConvertStringSidToSidW`
