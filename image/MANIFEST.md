...
132 `.asm` files across 4 System32 DLL folders (materialized under `tree/Windows/System32/`).
...
## Windows/System32/crypt32.dll — 13 functions
`CryptBinaryToStringA`, `CryptBinaryToStringA`, `CryptBinaryToStringA`, `CryptBinaryToStringA`, `CryptBinaryToStringW`, `CryptBinaryToStringW`, `CryptBinaryToStringW`, `CryptBinaryToStringW`, `CryptStringToBinaryA`, `CryptStringToBinaryA`, `CryptStringToBinaryA`, `CryptStringToBinaryW`, `CryptStringToBinaryW`
