; advapi32.dll!ConvertSidToStringSidA  --  hand-written x86-64 reimplementation (3.37x vs shipped)
; source of truth: changes/271-convertsidtostringsida/  (reference.c + correctness.c + bench.c)
