; advapi32.dll!ConvertSidToStringSidW  --  hand-written x86-64 reimplementation (2.52x vs shipped)
; source of truth: changes/270-convertsidtostringsid/  (reference.c + correctness.c + bench.c)
