; crypt32.dll!CryptStringToBinaryA  --  hand-written x86-64 reimplementation (36.3x vs shipped)
; source of truth: changes/082-cryptstringtobinary-base64/  (reference.c + correctness.c + bench.c)
