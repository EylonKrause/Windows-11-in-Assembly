; crypt32.dll!CryptBinaryToStringW  --  hand-written x86-64 reimplementation (77x vs shipped)
; source of truth: changes/091-cryptbinarytostringw-hexfmt/  (reference.c + correctness.c + bench.c)
