; crypt32.dll!CryptBinaryToStringW  --  hand-written x86-64 reimplementation (8.9x vs shipped)
; source of truth: changes/083-cryptbinarytostringw-base64/  (reference.c + correctness.c + bench.c)
