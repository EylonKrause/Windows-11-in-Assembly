; crypt32.dll!CryptStringToBinaryW  --  hand-written x86-64 reimplementation (5.8x vs shipped)
; source of truth: changes/107-cryptstringtobinaryw-base64any/  (reference.c + correctness.c + bench.c)
