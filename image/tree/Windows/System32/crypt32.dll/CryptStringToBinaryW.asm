; crypt32.dll!CryptStringToBinaryW  --  hand-written x86-64 reimplementation (38.7x vs shipped)
; source of truth: changes/084-cryptstringtobinaryw-base64/  (reference.c + correctness.c + bench.c)
