; crypt32.dll!CryptBinaryToStringA  --  hand-written x86-64 reimplementation (24.5x vs shipped)
; source of truth: changes/081-cryptbinarytostring-base64/  (reference.c + correctness.c + bench.c)
