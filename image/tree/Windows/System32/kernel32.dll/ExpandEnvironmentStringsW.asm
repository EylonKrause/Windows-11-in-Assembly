; kernel32.dll!ExpandEnvironmentStringsW  --  hand-written x86-64 reimplementation (3.63x vs shipped)
; source of truth: changes/291-expandenvironmentstringsw/  (reference.c + correctness.c + bench.c)
