; kernelbase.dll!UrlUnescapeA  --  hand-written x86-64 reimplementation (34.66x vs shipped)
; source of truth: changes/248-urlunescapea/  (reference.c + correctness.c + bench.c)
