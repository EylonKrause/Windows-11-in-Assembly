; kernelbase.dll!FindStringOrdinal  --  hand-written x86-64 reimplementation (24.8x vs shipped)
; source of truth: changes/254-findstringordinal/  (reference.c + correctness.c + bench.c)
