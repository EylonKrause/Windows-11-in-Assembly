; kernelbase.dll!PathCanonicalizeW  --  hand-written x86-64 reimplementation (22.11x vs shipped)
; source of truth: changes/246-pathcanonicalizew/  (reference.c + correctness.c + bench.c)
