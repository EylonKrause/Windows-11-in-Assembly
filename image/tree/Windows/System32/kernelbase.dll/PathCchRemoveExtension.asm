; kernelbase.dll!PathCchRemoveExtension  --  hand-written x86-64 reimplementation (2.59x vs shipped)
; source of truth: changes/144-pathcchremoveextension/  (reference.c + correctness.c + bench.c)
