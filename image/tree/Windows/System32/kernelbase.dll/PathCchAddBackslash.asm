; kernelbase.dll!PathCchAddBackslash  --  hand-written x86-64 reimplementation (2.17x vs shipped)
; source of truth: changes/164-pathcchaddbackslash/  (reference.c + correctness.c + bench.c)
