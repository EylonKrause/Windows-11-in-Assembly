; kernelbase.dll!PathCchFindExtension  --  hand-written x86-64 reimplementation (4.42x vs shipped)
; source of truth: changes/143-pathcchfindextension/  (reference.c + correctness.c + bench.c)
