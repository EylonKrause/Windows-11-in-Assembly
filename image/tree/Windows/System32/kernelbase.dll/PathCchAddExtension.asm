; kernelbase.dll!PathCchAddExtension  --  hand-written x86-64 reimplementation (3.80x vs shipped)
; source of truth: changes/160-pathcchaddextension/  (reference.c + correctness.c + bench.c)
