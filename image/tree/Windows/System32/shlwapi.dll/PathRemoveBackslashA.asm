; shlwapi.dll!PathRemoveBackslashA  --  hand-written x86-64 reimplementation (2.99x vs shipped)
; source of truth: changes/232-pathremovebackslasha/  (reference.c + correctness.c + bench.c)
