; shlwapi.dll!PathFindNextComponentA  --  hand-written x86-64 reimplementation (9.07x vs shipped)
; source of truth: changes/234-pathfindnextcomponenta/  (reference.c + correctness.c + bench.c)
