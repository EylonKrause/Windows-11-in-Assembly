; shlwapi.dll!StrCatBuffW  --  hand-written x86-64 reimplementation (3.59x vs shipped)
; source of truth: changes/170-strcatbuffw/  (reference.c + correctness.c + bench.c)
