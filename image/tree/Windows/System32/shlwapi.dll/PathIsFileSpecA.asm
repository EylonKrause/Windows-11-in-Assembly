; shlwapi.dll!PathIsFileSpecA  --  hand-written x86-64 reimplementation (55.14x vs shipped)
; source of truth: changes/235-pathisfilespeca/  (reference.c + correctness.c + bench.c)
