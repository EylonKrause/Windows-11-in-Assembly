; shlwapi.dll!PathIsPrefixA  --  hand-written x86-64 reimplementation (111.16x vs shipped)
; source of truth: changes/237-pathisprefixa/  (reference.c + correctness.c + bench.c)
