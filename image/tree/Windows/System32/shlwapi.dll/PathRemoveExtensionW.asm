; shlwapi.dll!PathRemoveExtensionW  --  hand-written x86-64 reimplementation (2.98x vs shipped)
; source of truth: changes/140-pathremoveextensionw/  (reference.c + correctness.c + bench.c)
...
wia_pathremoveextw PROC
        ...
        vpcmpeqw  ymm5, ymm0, ymmword ptr [c_spcm]  ; a SPACE stops the scan too
        vpor      ymm4, ymm4, ymm5
        vpmovmskb r10d, ymm4
