; shlwapi.dll!PathRemoveBackslashW  --  hand-written x86-64 reimplementation (2.10x vs shipped)
; source of truth: changes/171-pathremovebackslashw/  (reference.c + correctness.c + bench.c)
