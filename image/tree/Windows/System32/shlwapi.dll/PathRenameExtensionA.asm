; shlwapi.dll!PathRenameExtensionA  --  hand-written x86-64 reimplementation (23.55x vs shipped)
; source of truth: changes/224-pathrenameextensiona/  (reference.c + correctness.c + bench.c)
