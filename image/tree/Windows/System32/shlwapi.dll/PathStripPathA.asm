; shlwapi.dll!PathStripPathA  --  hand-written x86-64 reimplementation (14.85x vs shipped)
; source of truth: changes/219-pathstrippatha/  (reference.c + correctness.c + bench.c)
