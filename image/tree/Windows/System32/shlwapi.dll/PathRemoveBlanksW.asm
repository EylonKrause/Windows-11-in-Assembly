; shlwapi.dll!PathRemoveBlanksW  --  hand-written x86-64 reimplementation (4.23x vs shipped)
; source of truth: changes/141-pathremoveblanksw/  (reference.c + correctness.c + bench.c)
