; shlwapi.dll!StrCatBuffA  --  hand-written x86-64 reimplementation (4.27x vs shipped)
; source of truth: changes/231-strcatbuffa/  (reference.c + correctness.c + bench.c)
