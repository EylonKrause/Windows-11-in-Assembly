; shlwapi.dll!PathQuoteSpacesW  --  hand-written x86-64 reimplementation (2.06x vs shipped)
; source of truth: changes/172-pathquotespacesw/  (reference.c + correctness.c + bench.c)
