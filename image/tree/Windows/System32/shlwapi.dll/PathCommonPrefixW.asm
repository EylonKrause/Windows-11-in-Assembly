; shlwapi.dll!PathCommonPrefixW  --  hand-written x86-64 reimplementation (26.3x vs shipped)
; source of truth: changes/167-pathcommonprefixw/  (reference.c + correctness.c + bench.c)
