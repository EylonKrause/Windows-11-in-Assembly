; rpcrt4.dll!UuidFromStringA  --  hand-written x86-64 reimplementation (7.45x vs shipped)
; source of truth: changes/205-uuidfromstringa/  (reference.c + correctness.c + bench.c)
