; rpcrt4.dll!UuidFromStringW  --  hand-written x86-64 reimplementation (2.41x vs shipped)
; source of truth: changes/208-uuidfromstringw/  (reference.c + correctness.c + bench.c)
