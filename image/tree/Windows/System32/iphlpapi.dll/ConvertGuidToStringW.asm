; iphlpapi.dll!ConvertGuidToStringW  --  hand-written x86-64 reimplementation (37.30x vs shipped)
; source of truth: changes/202-convertguidtostringw/  (reference.c + correctness.c + bench.c)
