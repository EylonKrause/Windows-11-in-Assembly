; ntdll.dll!RtlIpv6StringToAddressW  --  hand-written x86-64 reimplementation (3.62x vs shipped)
; source of truth: changes/166-rtlipv6stringtoaddressw/  (reference.c + correctness.c + bench.c)
