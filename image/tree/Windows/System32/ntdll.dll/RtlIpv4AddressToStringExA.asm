; ntdll.dll!RtlIpv4AddressToStringExA  --  hand-written x86-64 reimplementation (9.78x vs shipped)
; source of truth: changes/065-rtlipv4addresstostringexa/  (reference.c + correctness.c + bench.c)
