; ntdll.dll!RtlIpv4StringToAddressA  --  hand-written x86-64 reimplementation (1.53x vs shipped)
; source of truth: changes/114-rtlipv4stringtoaddress/  (reference.c + correctness.c + bench.c)
