; ntdll.dll!RtlInitUnicodeStringEx  --  hand-written x86-64 reimplementation (1.40x vs shipped)
; source of truth: changes/096-rtlinitunicodestringex/  (reference.c + correctness.c + bench.c)
