; ntdll.dll!RtlAreBitsClear  --  hand-written x86-64 reimplementation (3.45x vs shipped)
; source of truth: changes/192-rtlarebitsclear/  (reference.c + correctness.c + bench.c)
