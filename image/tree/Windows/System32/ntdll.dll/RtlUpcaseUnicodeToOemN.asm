; ntdll.dll!RtlUpcaseUnicodeToOemN  --  hand-written x86-64 reimplementation (4.19x vs shipped)
; source of truth: changes/031-rtlupcaseunicodetooemn/  (reference.c + correctness.c + bench.c)
