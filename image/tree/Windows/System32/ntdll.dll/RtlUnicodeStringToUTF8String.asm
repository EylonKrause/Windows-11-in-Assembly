; ntdll.dll!RtlUnicodeStringToUTF8String  --  hand-written x86-64 reimplementation (3.53x vs shipped)
; source of truth: changes/268-rtlunicodestringtoutf8string/  (reference.c + correctness.c + bench.c)
