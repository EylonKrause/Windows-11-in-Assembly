; ntdll.dll!RtlUnicodeToMultiByteN  --  hand-written x86-64 reimplementation (3.93x vs shipped)
; source of truth: changes/021-rtlunicodetomultibyten/  (reference.c + correctness.c + bench.c)
