; ntdll.dll!RtlInitStringEx  --  hand-written x86-64 reimplementation (1.37x vs shipped)
; source of truth: changes/098-rtlinitstringex/  (reference.c + correctness.c + bench.c)
