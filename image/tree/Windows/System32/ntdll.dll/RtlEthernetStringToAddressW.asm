; ntdll.dll!RtlEthernetStringToAddressW  --  hand-written x86-64 reimplementation (4.17x vs shipped)
; source of truth: changes/120-rtlethernetstringtoaddressw/  (reference.c + correctness.c + bench.c)
