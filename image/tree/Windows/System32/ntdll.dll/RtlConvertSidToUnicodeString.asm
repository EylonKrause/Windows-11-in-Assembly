; ntdll.dll!RtlConvertSidToUnicodeString  --  hand-written x86-64 reimplementation (1.42x vs shipped)
; source of truth: changes/067-rtlconvertsidtounicodestring/  (reference.c + correctness.c + bench.c)
