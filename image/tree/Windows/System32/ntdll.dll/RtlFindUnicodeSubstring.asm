; ntdll.dll!RtlFindUnicodeSubstring  --  hand-written x86-64 reimplementation (74.5x vs shipped)
; source of truth: changes/252-rtlfindunicodesubstring/  (reference.c + correctness.c + bench.c)
