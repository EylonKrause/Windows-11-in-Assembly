; ntdll.dll!RtlCompareUnicodeStrings  --  hand-written x86-64 reimplementation (16.03x vs shipped)
; source of truth: changes/263-rtlcompareunicodestrings/  (reference.c + correctness.c + bench.c)
