; ntdll.dll!RtlSecondsSince1970ToTime  --  hand-written x86-64 reimplementation (2.00x vs shipped)
; source of truth: changes/128-rtlsecondssince1970totime/  (reference.c + correctness.c + bench.c)
