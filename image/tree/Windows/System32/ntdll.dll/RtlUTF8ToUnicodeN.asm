; ntdll.dll!RtlUTF8ToUnicodeN  --  hand-written x86-64 reimplementation (3.12x vs shipped)
; source of truth: changes/034-rtlutf8tounicoden/  (reference.c + correctness.c + bench.c)
