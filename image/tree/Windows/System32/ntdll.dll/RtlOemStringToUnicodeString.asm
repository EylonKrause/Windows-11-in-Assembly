; ntdll.dll!RtlOemStringToUnicodeString  --  hand-written x86-64 reimplementation (5.50x vs shipped)
; source of truth: changes/025-rtloemstringtounicodestring/  (reference.c + correctness.c + bench.c)
