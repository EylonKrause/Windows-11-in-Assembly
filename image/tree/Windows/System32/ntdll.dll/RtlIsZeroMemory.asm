; ntdll.dll!RtlIsZeroMemory  --  hand-written x86-64 reimplementation (12.38x vs shipped)
; source of truth: changes/266-rtliszeromemory/  (reference.c + correctness.c + bench.c)
