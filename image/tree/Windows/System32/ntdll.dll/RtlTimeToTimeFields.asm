; ntdll.dll!RtlTimeToTimeFields  --  hand-written x86-64 reimplementation (1.73x vs shipped)
; source of truth: changes/126-rtltimetotimefields/  (reference.c + correctness.c + bench.c)
