; ntdll.dll!RtlEqualUnicodeString  --  hand-written x86-64 reimplementation (1.96x vs shipped)
; source of truth: changes/010-rtlequalunicodestring/  (reference.c + correctness.c + bench.c)
; validated bit-exact vs the live export; see that dir's RESULTS.md.
;----------------------------------------------------------------------
; changes/010-rtlequalunicodestring/impl.asm
; BOOLEAN wia_rtlequstr(const UNICODE_STRING* s1, const UNICODE_STRING* s2, BOOLEAN ci)
;   [Win64: rcx, rdx, r8b -> al]
;
; Reimplements ntdll!RtlEqualUnicodeString. Equal iff same Length and same
; content (upcased if ci). CS: 32-byte AVX2 wchar compare. CI: 8-wchar blocks,
