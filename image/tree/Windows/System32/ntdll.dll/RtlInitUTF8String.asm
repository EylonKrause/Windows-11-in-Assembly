; ntdll.dll!RtlInitUTF8String  --  hand-written x86-64 reimplementation (7.16x vs shipped)
; source of truth: changes/264-rtlinitutf8string/  (reference.c + correctness.c + bench.c)
