; ntdll.dll!RtlUnicodeToOemN  --  hand-written x86-64 reimplementation (6.34x vs shipped)
; source of truth: changes/028-rtlunicodetooemn/  (reference.c + correctness.c + bench.c)
