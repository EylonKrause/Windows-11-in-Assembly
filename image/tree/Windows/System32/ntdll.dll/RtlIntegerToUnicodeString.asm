; ntdll.dll!RtlIntegerToUnicodeString  --  hand-written x86-64 reimplementation (2.94x vs shipped)
; source of truth: changes/052-rtlintegertounicodestring/  (reference.c + correctness.c + bench.c)
