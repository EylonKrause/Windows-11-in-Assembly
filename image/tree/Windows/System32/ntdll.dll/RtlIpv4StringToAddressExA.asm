; ntdll.dll!RtlIpv4StringToAddressExA  --  hand-written x86-64 reimplementation (1.96x vs shipped)
; source of truth: changes/116-rtlipv4stringtoaddressex/  (reference.c + correctness.c + bench.c)
