; ntdll.dll!RtlInitString  --  hand-written x86-64 reimplementation (1.43x vs shipped)
; source of truth: changes/095-rtlinitstring/  (reference.c + correctness.c + bench.c)
