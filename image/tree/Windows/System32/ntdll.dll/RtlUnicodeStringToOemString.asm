; ntdll.dll!RtlUnicodeStringToOemString  --  hand-written x86-64 reimplementation (7.68x vs shipped)
; source of truth: changes/024-rtlunicodestringtooemstring/  (reference.c + correctness.c + bench.c)
