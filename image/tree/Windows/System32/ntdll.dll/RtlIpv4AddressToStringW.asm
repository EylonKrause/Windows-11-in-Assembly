; ntdll.dll!RtlIpv4AddressToStringW  --  hand-written x86-64 reimplementation (23.7x vs shipped)
; source of truth: changes/061-rtlipv4addresstostringw/  (reference.c + correctness.c + bench.c)
