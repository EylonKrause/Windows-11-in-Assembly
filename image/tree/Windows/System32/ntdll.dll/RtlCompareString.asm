; ntdll.dll!RtlCompareString  --  hand-written x86-64 reimplementation (4.47x vs shipped)
; source of truth: changes/012-rtlcomparestring/  (reference.c + correctness.c + bench.c)
