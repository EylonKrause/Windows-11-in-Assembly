; ntdll.dll!RtlIpv6AddressToStringW  --  hand-written x86-64 reimplementation (7.42x vs shipped)
; source of truth: changes/064-rtlipv6addresstostringw/  (reference.c + correctness.c + bench.c)
