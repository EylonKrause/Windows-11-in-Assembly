; ntdll.dll!RtlIpv6AddressToStringExW  --  hand-written x86-64 reimplementation (8.38x vs shipped)
; source of truth: changes/069-rtlipv6addresstostringexw/  (reference.c + correctness.c + bench.c)
