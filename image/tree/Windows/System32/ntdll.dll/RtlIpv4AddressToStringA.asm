; ntdll.dll!RtlIpv4AddressToStringA  --  hand-written x86-64 reimplementation (16.6x vs shipped)
; source of truth: changes/059-rtlipv4addresstostringa/  (reference.c + correctness.c + bench.c)
