; ntdll.dll!RtlStringFromGUIDEx  --  hand-written x86-64 reimplementation (25.5x vs shipped)
; source of truth: changes/058-rtlstringfromguidex/  (reference.c + correctness.c + bench.c)
