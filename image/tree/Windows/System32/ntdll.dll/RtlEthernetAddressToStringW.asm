; ntdll.dll!RtlEthernetAddressToStringW  --  hand-written x86-64 reimplementation (36.0x vs shipped)
; source of truth: changes/062-rtlethernetaddresstostringw/  (reference.c + correctness.c + bench.c)
