; ntdll.dll!RtlPrefixUnicodeString  --  hand-written x86-64 reimplementation (1.97x vs shipped)
; source of truth: changes/011-rtlprefixunicodestring/  (reference.c + correctness.c + bench.c)
