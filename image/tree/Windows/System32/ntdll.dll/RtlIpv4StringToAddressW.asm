; ntdll.dll!RtlIpv4StringToAddressW  --  hand-written x86-64 reimplementation (1.51x vs shipped)
; source of truth: changes/115-rtlipv4stringtoaddressw/  (reference.c + correctness.c + bench.c)
