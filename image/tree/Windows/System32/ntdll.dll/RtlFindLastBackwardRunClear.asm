; ntdll.dll!RtlFindLastBackwardRunClear  --  hand-written x86-64 reimplementation (12.17x vs shipped)
; source of truth: changes/261-rtlfindnextforwardrunclear/  (reference.c + correctness.c + bench.c)
