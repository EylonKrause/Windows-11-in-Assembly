; ntdll.dll!RtlCompareMemory  --  hand-written x86-64 reimplementation (4.42x vs shipped)
; source of truth: changes/007-rtlcomparememory/  (reference.c + correctness.c + bench.c)
