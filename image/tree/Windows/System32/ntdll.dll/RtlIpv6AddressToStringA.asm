; ntdll.dll!RtlIpv6AddressToStringA  --  hand-written x86-64 reimplementation (5.92x vs shipped)
; source of truth: changes/063-rtlipv6addresstostringa/  (reference.c + correctness.c + bench.c)
