; ntdll.dll!RtlDowncaseUnicodeString  --  hand-written x86-64 reimplementation (11.15x vs shipped)
; source of truth: changes/017-rtldowncaseunicodestring/  (reference.c + correctness.c + bench.c)
