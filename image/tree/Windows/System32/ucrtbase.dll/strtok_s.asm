; ucrtbase.dll!strtok_s  --  hand-written x86-64 reimplementation (5.43x vs shipped)
; source of truth: changes/147-strtok-s/  (reference.c + correctness.c + bench.c)
; validated bit-exact vs the live export; see that dir's RESULTS.md.
;----------------------------------------------------------------------
; changes/147-strtok-s/impl.asm
...
tk_token:
        ...
        and       ecx, 31
        vmovdqa   ymm0, ymmword ptr [r9]
        vpcmpeqb  ymm1, ymm0, ymm3                  ; seed with the terminator
        mov       r10, rsi
tk_s2:
        movzx     eax, byte ptr [r10]
        test      al, al
...
tk_p2_here:
        ...
        cmp       byte ptr [r11], 0
        je        tk_atend
        mov       byte ptr [r11], 0                 ; terminate the token
        inc       r11
tk_atend:
        mov       [rdi], r11
        mov       rax, r8
