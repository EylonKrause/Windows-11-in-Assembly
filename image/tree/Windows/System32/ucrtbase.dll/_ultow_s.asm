; ucrtbase.dll!_ultow_s  --  hand-written x86-64 reimplementation (1.55x vs shipped)
; source of truth: changes/201-ultow-s/  (reference.c + correctness.c + bench.c)
; validated bit-exact vs the live export; see that dir's RESULTS.md.
;----------------------------------------------------------------------
; changes/201-ultow-s/impl.asm
