...
| [121](changes/121-rtlipv6stringtoaddress/) | `RtlIpv6StringToAddressA` (IPv6 parse: `::`, embedded IPv4; parse-side of 063) | `ntdll.dll!RtlIpv6StringToAddressA` | **LANDED** — **4.91×** (up to **10.8×**; 5M-fuzz bit-exact; 11-pass RE; `W` scoped out — Unicode digits) |
