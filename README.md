...
| [107](changes/107-cryptstringtobinaryw-base64any/) | `CryptStringToBinaryW` wide BASE64_ANY decode (auto-detect) | `crypt32.dll!CryptStringToBinaryW` | **LANDED** — **3.8×** (3.5×–5.0×; wide, sets pdwFlags 0/1) |
