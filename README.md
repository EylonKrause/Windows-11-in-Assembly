...
| [092](changes/092-cryptbinarytostring-base64header/) | `CryptBinaryToStringA` PEM-header base64 — BASE64HEADER/REQUESTHEADER/X509CRLHEADER (081 base64 core + BEGIN/END wrapper) | `crypt32.dll!CryptBinaryToStringA` | **LANDED** — **6.1×** (3.2×–7.7×; binary→PEM cert/CRL/request) |
