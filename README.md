...
| [092](changes/092-cryptbinarytostring-base64header/) | `CryptBinaryToStringA` PEM-header base64 — BASE64HEADER/REQUESTHEADER/X509CRLHEADER (081 base64 core + BEGIN/END wrapper) | `crypt32.dll!CryptBinaryToStringA` | **LANDED** — **10.9×** (4.0×–20×; binary→PEM cert/CRL/request) |
| [093](changes/093-cryptbinarytostringw-base64header/) | `CryptBinaryToStringW` wide PEM-header base64, 3 modes (SSSE3 core + reverse widen) | `crypt32.dll!CryptBinaryToStringW` | **LANDED** — **53×** (8.6×–417×; wide PEM output) |
