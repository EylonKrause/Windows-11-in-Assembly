...
| [106](changes/106-cryptstringtobinary-base64any/) | `CryptStringToBinaryA` BASE64_ANY decode (auto-detect PEM vs plain base64) | `crypt32.dll!CryptStringToBinaryA` | **LANDED** — **3.7×** (3.6×–4.1×; sets pdwFlags 0/1) |
