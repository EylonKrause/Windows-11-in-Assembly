@echo off
REM ===========================================================================
REM  LIVE-RUN PROOF for changes 209, 210 and 211 -- lstrcpynW + CompareStringOrdinal + lstrcpynA.
...
cl /nologo /O2 /MD live_subst_kernelbase.c "%C%\210-comparestringordinal\wrapper.c" "%C%\210-comparestringordinal\upcase.c" seh209.obj seh211.obj lcpn.obj cso.obj lcpna.obj /Fe:live_subst_kernelbase.exe >nul || goto :err
