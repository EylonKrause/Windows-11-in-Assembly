@echo off
REM ===========================================================================
REM  LIVE-RUN PROOF for changes 209, 210, 211 and 225 -- lstrcpynW + CompareStringOrdinal
REM  + lstrcpynA + lstrlenA + lstrcpyA.
...
cl /nologo /O2 /MD /EHa live_subst_kernelbase.c "%C%\210-comparestringordinal\wrapper.c" "%C%\210-comparestringordinal\upcase.c" seh209.obj seh211.obj seh225.obj seh227.obj lcpn.obj cso.obj lcpna.obj lena.obj lcpa.obj /Fe:live_subst_kernelbase.exe >nul || goto :err
