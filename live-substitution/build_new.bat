...
ml64 /nologo /c /Fo ss.obj   "%C%\077-strset\impl.asm"    >nul || goto :err
ml64 /nologo /c /Fo sn.obj   "%C%\078-strnset\impl.asm"   >nul || goto :err
ml64 /nologo /c /Fo ws.obj   "%C%\079-wcsset\impl.asm"    >nul || goto :err
ml64 /nologo /c /Fo wn.obj   "%C%\080-wcsnset\impl.asm"   >nul || goto :err
...
cl /nologo /O2 /c "%C%\077-strset\reference.c"  /Foref_ss.obj  >nul || goto :err
cl /nologo /O2 /c "%C%\078-strnset\reference.c" /Foref_sn.obj  >nul || goto :err
cl /nologo /O2 /c "%C%\079-wcsset\reference.c"  /Foref_ws.obj  >nul || goto :err
cl /nologo /O2 /c "%C%\080-wcsnset\reference.c" /Foref_wn.obj  >nul || goto :err
cl /nologo /O2 /c "%C%\072-ultow\dec2.c"        /Fodec2n.obj   >nul || goto :err
cl /nologo /O2 /c live_subst_new.c /Folsn.obj >nul || goto :err
link /nologo /OUT:live_subst_new.exe lsn.obj sr.obj wr.obj ul.obj u64.obj itw.obj i64.obj ss.obj sn.obj ws.obj wn.obj ref_sr.obj ref_wr.obj ref_ul.obj ref_u64.obj ref_it.obj ref_i64.obj ref_ss.obj ref_sn.obj ref_ws.obj ref_wn.obj dec2n.obj >nul || goto :err
