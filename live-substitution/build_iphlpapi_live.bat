...
ml64 /nologo /c /Focgsa.obj "%C%\203-convertguidtostringa\impl.asm" >nul || goto :err
cl /nologo /O2 /MD live_subst_iphlpapi.c cgs.obj cgsa.obj /Fe:live_subst_iphlpapi.exe >nul || goto :err
