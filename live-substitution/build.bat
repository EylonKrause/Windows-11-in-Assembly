...
cl /nologo /O2 live_subst.c ref_wcslen.obj ref_memchr.obj ref_wcschr.obj ref_wcscmp.obj ref_rcm.obj ref_rcu.obj ref_upcasestr.obj upcase.obj wcslen.obj memchr.obj wcschr.obj wcscmp.obj rcm.obj rcu.obj upcasestr.obj /Fe:live_subst.exe >nul || goto :err
"%H%live_subst.exe"
endlocal & exit /b 0
:err
