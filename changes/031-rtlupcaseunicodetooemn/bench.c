...
int main(void){
    wia_upoemmap_init();
    HMODULE h=LoadLibraryW(L"ntdll.dll"); sys=(fn)GetProcAddress(h,"RtlUpcaseUnicodeToOemN");
    ...
    return wia_bench_compare("RtlUpcaseUnicodeToOemN  (wia AVX2 vs ntdll)", cs, K, 200);
}
