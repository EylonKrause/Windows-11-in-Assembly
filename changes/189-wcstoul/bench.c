...
static uint64_t op_ours(void* c){ CASE* k=(CASE*)c; wchar_t* e;
                                  return (uint64_t)(unsigned)wia_wcstoul(k->s,&e,k->base) ^ (uint64_t)(uintptr_t)e; }
...
int main(void){
    ...
    static const char* names[] = {
        "\"7\" b10", "\"-987654\" b10 (mod 2^32)", "\"2147483647\" b10", "\"0x1abcdef0\" b0",
    ...
    return wia_bench_compare("ucrtbase wcstoul (wia scalar + AVX2 block classifier vs ucrtbase)", cs, N, 300);
}
