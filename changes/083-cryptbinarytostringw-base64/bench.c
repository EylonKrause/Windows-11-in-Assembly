// changes/083-cryptbinarytostringw-base64/bench.c
...
#pragma optimize("", off)
static uint64_t op_ours(void*c){ ctx_t*m=(ctx_t*)c; unsigned long cch=m->cap; wia_b2sw(m->bin,m->n,0x1u|0x40000000u,m->out,&cch); return cch; }
...
int main(void){
    ...
    return wia_bench_compare("CryptBinaryToStringW base64  (wia SSSE3+widen vs crypt32)", cs, K, 150);
}
