/* Derive ucrtbase!_strlwr_s, then fuzz a candidate reference against the live export.
   The byte sibling of change 178 (_wcsupr_s) and the bounded form of change 047 (_strlwr).
   ...
   Build: cl /nologo /O2 /MD sls.c && sls.exe
*/
...
int main(void){
    ...
    S = (SLS)GetProcAddress(hu,"_strlwr_s");
