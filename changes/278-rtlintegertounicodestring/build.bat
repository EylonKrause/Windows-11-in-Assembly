@echo off
REM changes/278-rtlintegertounicodestring/build.bat -- assemble, gate on correctness, benchmark.
setlocal
...
cl /nologo /O2 /I "%H%..\..\harness" bench.c reference.c impl.obj user32.lib /Fe:bench.exe >nul || goto :err
"%H%bench.exe"
