...
int main(void){
    ...
    if(!failures) printf("CORRECTNESS: PASS (_itoa radix 2..36 AND every out-of-range radix that returns x values -2000..2000 + edges (incl INT_MIN) + 8000 random/radix, vs ucrtbase)\n");
