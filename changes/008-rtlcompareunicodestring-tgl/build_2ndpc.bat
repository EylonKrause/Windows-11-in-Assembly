...
cl /nologo /O2 correctness.c reference.c upcase.c impl_2ndpc.obj /Fe:correctness_2ndpc.exe >nul || goto :err
"%H%correctness_2ndpc.exe" || (echo CORRECTNESS FAILED & goto :err)
cl /nologo /O2 /I "%H%..\..\harness" bench.c reference.c upcase.c impl_2ndpc.obj /Fe:bench_2ndpc.exe >nul || goto :err
"%H%bench_2ndpc.exe"
endlocal & exit /b 0
:err
