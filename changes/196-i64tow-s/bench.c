...
typedef struct { long long v; size_t size; int radix; } CASE;
static wchar_t obuf[128];

#pragma optimize("", off)
static uint64_t op_ours(void* c){ CASE* k=(CASE*)c; return (uint64_t)wia_i64tow_s(k->v,obuf,k->size,k->radix); }
...
int main(void){
    ...
    static const char* names[] = {
        "42 b10", "-1234567890 b10", "19 digits b10", "_I64_MIN b10",
        "0x7fffffffffffffff b16", "64 bits b2", "19 digits b36", "19 digits b10 ERANGE" };
    C[0].v=42;                      C[0].size=32; C[0].radix=10;
    C[1].v=-1234567890LL;           C[1].size=32; C[1].radix=10;
    C[2].v=9223372036854775807LL;   C[2].size=32; C[2].radix=10;
    C[3].v=-9223372036854775807LL-1;C[3].size=32; C[3].radix=10;
    C[4].v=9223372036854775807LL;   C[4].size=32; C[4].radix=16;
    C[5].v=-1;                      C[5].size=80; C[5].radix=2;
    C[6].v=9223372036854775807LL;   C[6].size=32; C[6].radix=36;
    C[7].v=9223372036854775807LL;   C[7].size=12; C[7].radix=10;
    ...
    return wia_bench_compare("ucrtbase _i64tow_s (wia wide table/shift digits vs ucrtbase div-per-digit)", cs, N, 300);
}
