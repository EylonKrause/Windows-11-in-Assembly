...
cl /nologo /O2 correctness.c reference.c upcase.c impl_tgl.obj /Fe:correctness_tgl.exe >nul || goto :err
"%H%correctness_tgl.exe" || (echo CORRECTNESS FAILED & goto :err)
cl /nologo /O2 /I "%H%..\..\harness" bench.c reference.c upcase.c impl_tgl.obj /Fe:bench_tgl.exe >nul || goto :err
"%H%bench_tgl.exe"
endlocal & exit /b 0
:err
