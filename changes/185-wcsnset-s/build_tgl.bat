...
cl /nologo /O2 /MD correctness.c reference.c impl_tgl.obj /Fe:correctness_tgl.exe >nul || goto :err
"%H%correctness_tgl.exe" || (echo CORRECTNESS FAILED - not benchmarking & goto :err)
cl /nologo /O2 /MD /I "%H%..\..\harness" bench.c impl_tgl.obj /Fe:bench_tgl.exe >nul || goto :err
"%H%bench_tgl.exe"
