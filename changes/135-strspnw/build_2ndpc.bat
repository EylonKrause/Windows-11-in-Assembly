...
cl /nologo /O2 correctness.c reference.c impl_2ndpc.obj shlwapi.lib /Fe:correctness_2ndpc.exe >nul || goto :err
"%H%correctness_2ndpc.exe" || (echo CORRECTNESS FAILED & goto :err)
cl /nologo /Od /I "%H%..\..\harness" bench.c impl_2ndpc.obj shlwapi.lib /Fe:bench_2ndpc.exe >nul || goto :err
"%H%bench_2ndpc.exe"
endlocal & exit /b 0
:err
