...
cl /nologo /O2 correctness.c reference.c impl_tgl.obj ntdll.lib /Fe:correctness_tgl.exe >nul || goto :err
"%H%correctness_tgl.exe" || (echo CORRECTNESS FAILED & goto :err)
cl /nologo /Od /I "%H%..\..\harness" bench.c impl_tgl.obj ntdll.lib /Fe:bench_tgl.exe >nul || goto :err
"%H%bench_tgl.exe"
endlocal & exit /b 0
:err
