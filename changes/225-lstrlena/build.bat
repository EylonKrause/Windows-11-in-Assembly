...
cl /nologo /O2 /EHa /c seh.c /Fo:seh225.obj >nul || goto :err
cl /nologo /O2 /EHa correctness.c reference.c impl.obj seh225.obj /Fe:correctness.exe >nul || goto :err
"%H%correctness.exe" || (echo CORRECTNESS FAILED - not benchmarking & goto :err)
cl /nologo /O2 /I "%H%..\..\harness" bench.c impl.obj seh225.obj /Fe:bench.exe >nul || goto :err
"%H%bench.exe"
