...
typedef struct { unsigned long v; size_t size; int radix; } CASE;
static wchar_t obuf[128];

#pragma optimize("", off)
static uint64_t op_ours(void* c){ CASE* k=(CASE*)c; return (uint64_t)wia_ultow_s(k->v,obuf,k->size,k->radix); }
...
int main(void){
    ...
    static const char* names[] = {
        "42 b10", "1234567890 b10", "10 digits b10", "ULONG_MAX b10",
        "0xffffffff b16", "32 bits b2", "10 digits b36", "10 digits b10 ERANGE" };
    C[0].v=42;            C[0].size=32; C[0].radix=10;
    C[1].v=1234567890UL;  C[1].size=32; C[1].radix=10;
    C[2].v=2147483647UL;  C[2].size=32; C[2].radix=10;
    C[3].v=4294967295UL;  C[3].size=32; C[3].radix=10;
    C[4].v=4294967295UL;  C[4].size=32; C[4].radix=16;
    C[5].v=4294967295UL;  C[5].size=40; C[5].radix=2;
    C[6].v=4294967295UL;  C[6].size=32; C[6].radix=36;
    C[7].v=2147483647UL;  C[7].size=6;  C[7].radix=10;
    static const size_t bytes[] = { 2,11,10,11,8,32,7,6 };
    for(int i=0;i<N;i++){ cs[i].label=names[i]; cs[i].bytes=bytes[i];
        cs[i].ours=op_ours; cs[i].system=op_sys; cs[i].ctx=&C[i]; }
    return wia_bench_compare("ucrtbase _ultow_s (wia wide table/shift digits vs ucrtbase div-per-digit)", cs, N, 300);
}
