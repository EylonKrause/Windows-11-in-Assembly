// changes/209-lstrcpynw/reference.c
// The correctness oracle for kernelbase!lstrcpynW. Not fast; just obviously right.
//
// Contract, every line measured against the live export in probes/lcp.c:
...
wchar_t* ref_lstrcpynw(wchar_t* dst, const wchar_t* src, int n)
{
    unsigned int max;
    unsigned int i;
