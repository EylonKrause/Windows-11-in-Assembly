// changes/063-rtlipv6addresstostringa/reference.c — scalar oracle (validated 0/3,000,000 vs ntdll).
static const char* hx="0123456789abcdef";
static char* eh(char* p, unsigned g){ if(g>=0x1000)*p++=hx[(g>>12)&15]; if(g>=0x100)*p++=hx[(g>>8)&15];
...
char* ref_v6fmt(const unsigned char* a, char* s){
